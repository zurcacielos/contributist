    ...
    >
      <div className="year-meta" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '12px', flex: isActive ? "0 0 auto" : "1 1 0%" }}>
          {!isActive && isHovered && (
            <span style={{ color: "var(--text-muted)", fontSize: "13px", fontStyle: "italic", whiteSpace: "nowrap" }}>
              {t('clickSelect')}
            </span>
          )}
            ...
            >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isSelected ? "var(--tool-active-bg)" : "var(--lang-trigger-bg)",
                    ...
                    onMouseEnter={(e) => {
                      if (!isSelected) {
                        e.currentTarget.style.backgroundColor = "var(--menubar-trigger-hover-bg)";
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: "var(--lang-trigger-bg)",
                ...
                {Object.keys(memeTemplates).map((name, index) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.backgroundColor = "var(--tool-active-bg)";
